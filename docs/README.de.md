...
> **Streamcord ist ein unabhängiges Projekt.** Es wurde ursprünglich von
...
Streamcord startet **[Vesktop](https://github.com/Vencord/Vesktop)** — einen echten, nativen Discord-Client — unsichtbar im Hintergrund und steuert ihn über das Chrome DevTools Protocol. Das Plugin injiziert einen kleinen Client und stellt alles im **Schnellzugriffsmenü** von Steam bereit.
...
- [Vesktop / Vencord](https://github.com/Vencord/Vesktop) — der native Discord-Client, den Streamcord steuert
