...
- **🖥️ Widok rozszerzony (proof of concept)** — Discord na pełnym ekranie, otwierany ikoną obok twojej nazwy: wiadomości prywatne z aktywnością każdej osoby, **znajomi** (aktywność, pisanie do każdego, połączenia, dodawanie po nazwie użytkownika, zaproszenia), **serwery** rozwijane w **członków według ról**, wydarzenia, kanały tekstowe i głosowe z ich **czatem kanału**, wszystkie wydarzenia w jednym miejscu, bieżące połączenie i ustawienia. Czaty otwierają się w widoku; **L1 / R1** cofają i przechodzą dalej, **B** wraca o jeden poziom: wychodzi z czatu albo z listy członków serwera, a potem oddaje panel szybkiego dostępu, który pasek boczny udostępnia też jako przycisk. Ustawienia panelu decydują, co otwiera ikona Steamcord; **Y** na osobie otwiera Profil, Wiadomość, Połączenie oraz akcje znajomych i blokowania. Wyjście z widoku nigdy nie kończy połączenia. Przyciemnienie tła ustawisz w ustawieniach — aż do całkowitego zasłonięcia. *Nadal proof of concept — spodziewaj się błędów, zgłoszenia mile widziane.*
- **Tryb streamera** — Podczas transmisji (Discord Go Live albo stream lub nagranie [BoneCast](https://github.com/Necrosiak/BoneCast)) powiadomienia są wstrzymywane, żeby nie trafiły do wideo, i pokazywane później. *Zawsze włączony* obejmuje OBS i inne programy do streamowania.
- **Nazwa wyświetlana** — Panel pokazuje twoją nazwę wyświetlaną z Discorda zamiast loginu, a zmienisz ją w Ustawieniach.
