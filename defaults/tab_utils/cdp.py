...
class Tab:
    ...
    async def evaluate(self, js, wait=False, user_gesture=False):
        params = {"expression": js}
        if user_gesture:
            # Simulate a user activation so Chromium's autoplay policy lets us
            # resume suspended AudioContexts in the hidden BrowserView.
